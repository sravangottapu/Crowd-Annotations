...
Others...<br>
<div class="ui-widget">
<input id="labels" type="text" name="labelnew" placeholder="New Category" value="">
...
<a href="http:localhost/team2cs243/firefox/popup/my.php" target="_blank">Dynamic update</a><br>
